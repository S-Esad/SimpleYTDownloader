...
def download():
    ...
    try:
        ...
        video.download("C:/Users/eskoa/Desktop")
...
Label(master, text="Please enter the link to your video below : ",
      font=("Calibri", 12)).grid(sticky=N, row=1, pady=15)
...
# Button
Button(master, width=20, text="Download", font=(
    "Calibri", 12), command=download).grid(sticky=N, row=3, pady=15)
master.mainloop()
